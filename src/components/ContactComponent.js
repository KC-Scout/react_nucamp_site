    ...
    validate(firstName, lastName, phoneNum, email) {
        ...
        if (this.state.touched.firstName) {
            if (firstName.length < 2) {
                ...
                errors.firstName = 'First name must be less than 15 characters or less.';
            }
        };
        if (this.state.touched.lastName) {
            if (lastName.length < 2) {
                errors.lastName = 'First name must be atleast 2 characters.';
            } else if (lastName.length > 15) {
                errors.lastName = 'First name must be less than 15 characters or less.';
            }
        }
        const reg = /^\d+$/;
        ...
        if (this.state.touched.email && !email.includes('@')) {
            errors.email = 'The email must include an @ symbol';
        }
